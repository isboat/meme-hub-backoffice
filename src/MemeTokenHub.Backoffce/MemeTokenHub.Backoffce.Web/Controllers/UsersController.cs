...
namespace Partners.Management.Web.Controllers
{
    ...
    public class UsersController : CustomBaseController
    {
        ...
        public UsersController(IUserService userService, IEmailSender emailSender, ITenantService tenantService)
        {
        ...
        public async Task<ActionResult> Index(string tenantId)
        {
            ...
            var model = new UserListViewModel
            {
                ...
                TenantId = tenantId,
                AllowedPartnerPermission = tenant != null && tenant.AllowedPartnerPermission,
            };
            return View(model);
        }
